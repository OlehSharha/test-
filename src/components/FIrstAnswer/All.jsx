      ...
      {isOpen
        ...
        ? (
          <section className="answers">
            ...
            <h3>Відповідь:</h3>
            <p>
              Ні не можна змінити значення псевдоелементів, але можна змінити стилі які до них застосовуються, для того щоб змінити стилі нам потрібно через querySelector вибрати наш елемент з псевдоелементом і потім використати
